                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex">
                                                        <a href="{{ route('pet.update', $pet->id) }}" class="btn btn-outline-primary btn-sm me-2">Edit</a>
                                                        <form action="{{ route('pet.delete', $pet->id) }}" method="POST" class="d-inline-block">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to delete this pet?')">Delete</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
